<html>
    <head>
        ...
        <style type="text/css">
            ...
            #excel-dl, #excel-spinner, #icondl-spinner, #qrcdl-spinner, #videodl-spinner, #reset-spinner, #qrcode-spinner {display:none}
...
<div class="card-template wk-col-3" style="display:none">
    ...
    <div class="wk-card-container-body"></div>
        ...
        <script src="files/scripts/scripts.js?version=332"></script>
    </body>
</html>