...
foreach($wksheets as $key=>$value){
                    ...
                    if(in_array($k, $order)){
                        ...
                        elseif($k == 'jumpStart'){
                            ...
                            if(isset($shibString)){
                                ...
                                $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&'.$thisParams;
    ...
    elseif ($key == 'database'){
        ...
        foreach($wksheets[$key] as $item){
            if($wksheets[$key][$i]['orderNumber'] !== 746896){
                ...
                if((isset($item['title'])) && (($item['title'] == 'Ovid MEDLINE(R)') || ($item['title'] == 'CAB Abstracts') || ($item['title'] == 'APA PsycINFO') || ($item['title'] == 'EMBASE') || (strpos($item['title'] , 'Food Science and Technology Abstracts') !== false) || ($item['title'] == 'INSPEC') || (strpos($item['title'] , 'Emcare') !== false) || ($item['formatShortName'] == 'dscvdb'))){
                    ...
                    unset($wksheets[$key][$i]);
                    if((isset($athensString)) && (isset($shibString))){
                        $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D='.$singleScode;
                    ...
                    unset($wksheets[$key][$i]);
                    if((isset($athensString)) && (isset($shibString))){
                        $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D=caba';
                        $thisShibJstartHTML = '<a href="'.$thisShibJstart.'">'.$thisShibJstart.'</a>';
        ...
        if(in_array('journal', $finalClasses)){
            ...
            if((isset($athensString)) && (isset($shibString))){
                $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D=ovft';
                $thisShibJstartHTML = '<a href="'.$thisShibJstart.'">'.$thisShibJstart.'</a>';
                ...
                $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D=yrovft';
                $thisShibJstartHTML = '<a href="'.$thisShibJstart.'">'.$thisShibJstart.'</a>';
        ...
        if(isset($purchaseArray)){
            foreach($purchaseArray as $k=>$v){
                ...
                if((isset($athensString)) && (isset($shibString))){
                    ...
                    $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D='.$thisScode;
                    $thisShibJstartHTML = '<a href="'.$thisShibJstart.'">'.$thisShibJstart.'</a>';
        ...
        if(!empty($ebmrArray)){
            ...
            foreach($extraEBMR as $k => $v){
                ...
                if((isset($athensString)) && (isset($shibString))){
                    ...
                    $thisShibJstart = 'https://openathens.ovid.com/secure-ssl/home.oa?idpselect='.$shibString.'&entityID='.$shibString.'&T=JS&NEWS=n&CSC=Y&PAGE=main&D='.$k;
                    $thisShibJstartHTML = '<a href="'.$thisShibJstart.'">'.$thisShibJstart.'</a>';
